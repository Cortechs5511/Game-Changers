...
public class PathA {
    ...
    public static RamseteCommand getPathA(Drive m_drive) {
        ...
        Trajectory pathA = TrajectoryGenerator.generateTrajectory(new Pose2d(0, 0, new Rotation2d()),
                List.of(new Translation2d(2.2098, -0.508), new Translation2d(3.7338, -1.27),
                        new Translation2d(4.4958, 1.016), new Translation2d(6.0198, 0.254)),
                new Pose2d(10, 0.254, new Rotation2d()), config);

        RamseteCommand command = new RamseteCommand(pathA, m_drive::getPose,
                new RamseteController(AutoConstants.kRamseteB, AutoConstants.kRamseteZeta),
                new SimpleMotorFeedforward(DriveConstants.ksVolts, DriveConstants.kvVoltSecondsPerMeter,
                        DriveConstants.kaVoltSecondsSquaredPerMeter),
                DriveConstants.kDriveKinematics, m_drive::getWheelSpeeds, new PIDController(0, 0, 0), // DriveConstants.kPDriveVel
                new PIDController(0, 0, 0), m_drive::setOutput, m_drive);
